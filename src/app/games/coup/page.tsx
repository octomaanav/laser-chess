...
export const metadata: Metadata = {
  ...
  description:
    'Play Coup online for free — a real-time multiplayer game of bluffing and deduction. Claim any character’s power and survive your rivals’ challenges. 2–6 players, share a link, no download.',
