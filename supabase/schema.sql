-- =============================================================
-- GAME NIGHT: COMPLETE SUPABASE DATABASE SCHEMA
-- =============================================================
-- This file contains the complete, consolidated PostgreSQL schema
-- for Game Night. You can run this directly in the Supabase SQL Editor
-- or apply migrations sequentially via supabase/migrations.
...
-- 7. Live Laser Chess Rooms (with explicit player columns)
...
-- 9. Permanent Game Match History
