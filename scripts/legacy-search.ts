// Standalone comparison baseline, not used by production. Verbatim copy of the
// original minimax search (git commit 4eebe39, src/game/bot/search.ts, before
// the transposition table and quiescence search), with only import paths
// adjusted and the entry point renamed to `legacySearch`. Used by
// scripts/compare-bot-search.ts.
import { applyAction, opposite } from '../src/game/engine';
